...
require (
	...
	github.com/crd2go/crd2go v0.0.0-20260430094551-91802e5f84b2
	...
	github.com/mongodb/mongodb-atlas-kubernetes/v2 v2.15.0
...
require (
	...
	go.mongodb.org/atlas-sdk/v20250312020 v20250312020.0.0 // indirect
