...
// Source: github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store (interfaces: ProjectLister,ProjectCreator,ProjectUpdater,ProjectDeleter,ProjectDescriber,ProjectUsersLister,ProjectUserDeleter,ProjectTeamLister,ProjectTeamAdder,ProjectTeamDeleter,OrgProjectLister,ProjectMDBVersionLister)
...
func (mr *MockProjectUpdaterMockRecorder) UpdateProject(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateProject", reflect.TypeOf((*MockProjectUpdater)(nil).UpdateProject), arg0)
}
...
// MockProjectMDBVersionLister is a mock of ProjectMDBVersionLister interface.
type MockProjectMDBVersionLister struct {
	ctrl     *gomock.Controller
	recorder *MockProjectMDBVersionListerMockRecorder
}

// MockProjectMDBVersionListerMockRecorder is the mock recorder for MockProjectMDBVersionLister.
type MockProjectMDBVersionListerMockRecorder struct {
	mock *MockProjectMDBVersionLister
}

// NewMockProjectMDBVersionLister creates a new mock instance.
func NewMockProjectMDBVersionLister(ctrl *gomock.Controller) *MockProjectMDBVersionLister {
	mock := &MockProjectMDBVersionLister{ctrl: ctrl}
	mock.recorder = &MockProjectMDBVersionListerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProjectMDBVersionLister) EXPECT() *MockProjectMDBVersionListerMockRecorder {
	return m.recorder
}

// MDBVersions mocks base method.
func (m *MockProjectMDBVersionLister) MDBVersions(arg0 string, arg1 *store.MDBVersionListOptions) (*admin.PaginatedAvailableVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MDBVersions", arg0, arg1)
	ret0, _ := ret[0].(*admin.PaginatedAvailableVersion)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// MDBVersions indicates an expected call of MDBVersions.
func (mr *MockProjectMDBVersionListerMockRecorder) MDBVersions(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MDBVersions", reflect.TypeOf((*MockProjectMDBVersionLister)(nil).MDBVersions), arg0, arg1)
}
