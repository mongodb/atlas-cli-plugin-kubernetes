...
// Source: github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store (interfaces: SearchNodesLister,SearchNodesCreator,SearchNodesUpdater,SearchNodesDeleter)
