...
// Source: github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store (interfaces: OperatorDBUsersStore)
...
func (m *MockOperatorDBUsersStore) DatabaseUsers(arg0 string) ([]admin.CloudDatabaseUser, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOperatorDBUsersStoreMockRecorder) DatabaseUsers(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DatabaseUsers", reflect.TypeOf((*MockOperatorDBUsersStore)(nil).DatabaseUsers), arg0)
}
