...
//go:generate mockgen -destination=../mocks/mock_global_cluster.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store GlobalClusterDescriber
