...
//go:generate mockgen -destination=../mocks/mock_events.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store OrganizationEventLister,ProjectEventLister,EventLister
