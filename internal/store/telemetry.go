...
//go:generate mockgen -destination=../mocks/mock_telemetry.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store EventsSender,UnauthEventsSender
