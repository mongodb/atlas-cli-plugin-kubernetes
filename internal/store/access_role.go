...
//go:generate mockgen -destination=../mocks/mock_access_role.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store CloudProviderAccessRoleLister
