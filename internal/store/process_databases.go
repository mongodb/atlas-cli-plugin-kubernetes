...
//go:generate mockgen -destination=../mocks/mock_process_databases.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store ProcessDatabaseLister
