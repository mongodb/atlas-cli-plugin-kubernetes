...
//go:generate mockgen -destination=../mocks/mock_search_nodes.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store SearchNodesLister,SearchNodesCreator,SearchNodesUpdater,SearchNodesDeleter
