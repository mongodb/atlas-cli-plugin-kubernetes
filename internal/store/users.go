...
//go:generate mockgen -destination=../mocks/mock_users.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store UserCreator,UserDescriber,UserLister,TeamUserLister
