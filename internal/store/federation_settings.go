...
//go:generate mockgen -destination=../mocks/mock_federation_settings_store.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store FederationSettingsDescriber
