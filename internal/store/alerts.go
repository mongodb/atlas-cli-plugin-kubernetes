...
//go:generate mockgen -destination=../mocks/mock_alerts.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store AlertDescriber,AlertLister,AlertAcknowledger
