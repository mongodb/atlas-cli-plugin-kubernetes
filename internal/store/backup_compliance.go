...
//go:generate mockgen -destination=../mocks/mock_backup_compliance.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store CompliancePolicyDescriber
