...
//go:generate mockgen -destination=../mocks/mock_encryption_at_rest.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store EncryptionAtRestDescriber
