...
//go:generate mockgen -destination=../mocks/mock_data_federation_query_limits.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store DataFederationQueryLimitLister,DataFederationQueryLimitDescriber,DataFederationQueryLimitCreator,DataFederationQueryLimitDeleter
