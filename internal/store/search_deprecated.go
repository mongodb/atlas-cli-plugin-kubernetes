...
//go:generate mockgen -destination=../mocks/mock_search_deprecated.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store SearchIndexListerDeprecated,SearchIndexCreatorDeprecated,SearchIndexDescriberDeprecated,SearchIndexUpdaterDeprecated,SearchIndexDeleterDeprecated,SearchIndexCreatorDescriberDeprecated
