...
//go:generate mockgen -destination=../mocks/mock_data_lake_pipelines_datasets.go -package=mocks github.com/mongodb/atlas-cli-plugin-kubernetes/internal/store PipelineDatasetDeleter
